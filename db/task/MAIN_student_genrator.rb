students = [ {nickname: 'ดรีม',school: 'โรงเรียนบ้านพลอย',tel_student:'-',tel_parent:'089-172-9445',name:'ดรีม',surname:'เจริญทรัพย์',gender: 'm',birth:'9-9-2010',grade: '1'},
...
students.each do |pupil|
  @student = Student.create!(
    ...
    school:     School.where(name: pupil[:school]).first[:id],
