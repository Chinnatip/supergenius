...
class MajorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create major" do
    assert_difference('Major.count') do
      post majors_url, params: { major: { major_code: @major.major_code, major_id: @major.major_id, name: @major.name } }
    end
  ...
  test "should update major" do
    patch major_url(@major), params: { major: { major_code: @major.major_code, major_id: @major.major_id, name: @major.name } }
