...
class ExamsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create exam" do
    assert_difference('Exam.count') do
      post exams_url, params: { exam: { issue: @exam.issue, ref_class: @exam.ref_class, score: @exam.score, student: @exam.student } }
    end
  ...
  test "should update exam" do
    patch exam_url(@exam), params: { exam: { issue: @exam.issue, ref_class: @exam.ref_class, score: @exam.score, student: @exam.student } }
