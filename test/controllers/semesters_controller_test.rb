...
class SemestersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create semester" do
    assert_difference('Semester.count') do
      post semesters_url, params: { semester: { course_count: @semester.course_count, description: @semester.description, name: @semester.name, year: @semester.year } }
    end
  ...
  test "should update semester" do
    patch semester_url(@semester), params: { semester: { course_count: @semester.course_count, description: @semester.description, name: @semester.name, year: @semester.year } }
