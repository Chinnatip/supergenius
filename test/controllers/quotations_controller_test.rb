...
class QuotationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create quotation" do
    assert_difference('Quotation.count') do
      post quotations_url, params: { quotation: { desc: @quotation.desc, title: @quotation.title } }
    end
  ...
  test "should update quotation" do
    patch quotation_url(@quotation), params: { quotation: { desc: @quotation.desc, title: @quotation.title } }
