...
class SeatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create seat" do
    assert_difference('Seat.count') do
      post seats_url, params: { seat: { checkin: @seat.checkin, classroom: @seat.classroom, status: @seat.status, student: @seat.student, valuate: @seat.valuate } }
    end
  ...
  test "should update seat" do
    patch seat_url(@seat), params: { seat: { checkin: @seat.checkin, classroom: @seat.classroom, status: @seat.status, student: @seat.student, valuate: @seat.valuate } }
